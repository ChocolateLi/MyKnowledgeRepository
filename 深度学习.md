...
![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\RNN\LSTM.png)
...
![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\RNN\LSTM exp.png)
...
![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\self-attention\self-attention8.png)

Q、K矩阵相乘，得到attention分数，再经过Softmax

![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\self-attention\self-attention9.png)

接下来就是通过V和A'相乘得到输出向量b

![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\self-attention\self-attention10.png)

self-attention就是一些列矩阵相乘，唯一需要学习的权重就是W，其他参数都是已知的

![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\self-attention\self-attention11.png)
...
1.对RNN最右边的输出要考虑最左边的输入，那么它必须把最左边的输入存到memory里面，然后接下来都不能忘掉，一路带到最右边，才能在最后一个时间点被考虑。但对于self-attention来说，没有这个问题。

2.RNN不能并行计算，它能够并行计算，处理所有的输出。

![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\self-attention\RNN和Self-attention.png)
...
想要寻找不同方面的相关性，一个q和一个k相乘，是一个相关性；另一个q和另一个k相乘，是另一个相关性；
...
![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\self-attention\self-attention12.png)

![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\self-attention\self-attention13.png)

![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\self-attention\self-attention14.png)
...
![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\BERT\Transformer\结构1.png)

![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\BERT\Transformer\结构2.png)

![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\BERT\Transformer\结构3.png)
...
![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\BERT\Transformer\结构4.png)
...
![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\BERT\Transformer\Encoder部门.png)
...
![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\BERT\Transformer\位置编码公式.png)
...
![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\BERT\Transformer\词向量+位置编码.png)
...
![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\BERT\Transformer\线性组合.png)
...
![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\BERT\Transformer\Attention过程.png)



获取q、k的过程

![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\BERT\Transformer\获取QK的过程.png)

计算Q、K相似度，得到attention的值

![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\BERT\Transformer\计算得到Attention的值.png)

实际代码使用的是矩阵，方便并行

![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\BERT\Transformer\Transformer矩阵.png)
...
![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\BERT\Transformer\残差网络求导.png)
...
![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\BERT\Transformer\例子.png)
...
![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\BERT\Transformer\decoder.png)

**为什么要Masked？**

可以简单理解为在做测试的时候，是不知道后面的信息。你训练的时候是知道，但你测试的时候是没有后面信息的，为了防止训练和预测之间有gap，所以需要一个mask，来掩盖后面的信息

![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\BERT\Transformer\masked.png)

**如何交互**

Encoder所有输出的值和每一个Decoder做交互

![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\BERT\Transformer\Encoder交互.png)

具体交互过程：

Encoder输出生成的是KV矩阵，Decoder是生成Q矩阵。多头注意力机制一定是有QKV三个矩阵

![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\BERT\Transformer\Decoder过程1.png)

虚线代表KV矩阵的输出

![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\BERT\Transformer\Decoder过程2.png)
...
![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\BERT\BERT整体结构.png)
...
![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\BERT\BERT输入表示.png)
...
![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\BERT\MLM.png)
...
huggingface里的模型：Transformer-XL、Longformer、Longformer_zh、XLNET
...
![](D:\github\MyKnowledgeRepository\machine_learning_img\deep_learning\BERT\Longformer注意力机制.png)
