...
# 创建用户
CREATE USER 'ranger'@'%' IDENTIFIED BY 'ranger_0753';
...
# mysql主机和root用户的用户密码
db_root_user=root
db_root_password=bigdata_0753
db_host=cesdb
# ranger需要的数据库名和用户信息
db_name=ranger
db_user=ranger
db_password=ranger_0753
# 其他ranger admin需要的用户密码
rangerAdmin_password=hadoop_0753
rangerTagsync_password=hadoop_0753
rangerUsersync_password=hadoop_0753
keyadmin_password=hadoop_0753
