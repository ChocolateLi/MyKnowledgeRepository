...
优化：73min(调节参数，分配更多资源) -> 28min(mapjoin优化，主站订单表的优化，减少数据传输) -> 18min
...
200多个指标。这是不合理的指标，因为很多指标感觉重复开发，也没啥关联。今天流量上来了，为什么上来，不知道，今天流量下去了，为什么下去了，不知道。也就说他不能进行追溯。一个优秀的指标体系应该是金字塔的，从最顶层的指标看，发现某个指标下去了，往下追溯，w为什么下去了，哪里出现问题了？
